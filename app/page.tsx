    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <FeatureSection
          ...
          description="Medhavy automatically creates summaries, quizzes, exams, and lecture notes while keeping you in control. AI proposes. You dispose. Your pedagogical expertise and teaching philosophy stay front and center."
        ...
        <FeatureSection
          ...
          description="Medhavy imports any course content materials and builds LMS modules, generates assessments, and creates lecture materials. Course prep that used to take weeks now takes an afternoon of review."
          ctaText="See how Medhavy saves time"
        ...
        <FeatureSection
          ...
          description="One cohesive course experience. Medhavy unifies textbooks, PDFs, images and videos, and existing LMS content—eliminating frustrating platform jumping for students and instructors."
